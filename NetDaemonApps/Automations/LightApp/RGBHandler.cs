...
public class RGBHandler : AvailableEnabledHandler
{
        ...
        : base(light, enabledToggle)
    {
        ...
        var motionSendsorId = allEntities.FirstOrDefault(e => e == "binary_sensor." + room + "_motion_sensor_motion");
        ...
        entities.BinarySensor.TodEvening.StateChanges()
            .Where(s => s.New.IsOn())
        ...
        isRightTime = mode?.State == "always" || 
            (mode?.State == "evening" && entities.BinarySensor.TodEvening.IsOn()) || 
